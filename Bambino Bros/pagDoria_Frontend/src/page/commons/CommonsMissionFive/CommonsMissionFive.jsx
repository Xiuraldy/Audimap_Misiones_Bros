...
import audioFive from '../../../assets/audio/missionFive.m4a'
import audiowin from '../../../assets/audio/winner.mp3' 

export const CommonsMissionFive = () => {
    ...
    const {contentTextMission, writeObject} = useWriteObject("Agenden a las personas que van a auditar.")
    ...
    const audio = new Audio(audioFive); //Audio del Objetivo
    ...
    return (
        <>
            ...
            <button className='send-mission'>{nevel >= 5 ? 'Misión Completada' : 'Misión Pendiente'}</button>
            <div className="content-mission">
                <div className="tasks" name="center">
                    <div className="program-meet">
                        <h1 className='link-calendar' onClick={() => completedMission()}>Programa aqui tu reunión<img src={ imgcursor } className='cursor-gif' /></h1>
                    </div>
                </div>
            </div>
            {/* Modal Del Objetivo */}
